<template>
  <div class="">
    <Switch
        v-model="enabled"
        :class="enabled ? 'bg-gray-600' : 'bg-yellow-300'"
    ...
    >
      ...
      <span
          ...
          class="pointer-events-none inline-block h-[34px] w-[34px] rounded-full dark:bg-gray-800 bg-green-500 shadow-lg transform ring-0 transition ease-in-out duration-200"
      />
    </Switch>
  </div>
</template>
